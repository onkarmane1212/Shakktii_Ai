          ...
          <div class="absolute left-0 right-0 bottom-0 p-6 z-30 transform translate-y-1/2 transition duration-300 h-full group-hover:translate-y-0 delay-100">
            <div class="h-1/2 relative">
              <div class="absolute bottom-0">
                <h2 class="font-bold text-white leading-tight transition duration-300 text-2xl pb-6 group-hover:underline">Electoral</h2>
              </div> 
            </div>
            <div class="h-1/2">
                <h3 class="font-bold text-white leading-tight transition duration-300 text- group-hover:underline">Ground Intelligence</h3>
              <p class="text-white pb-4 opacity-0 transition duration-300 group-hover:opacity-100">We use ground intelligence, whisper campaign and grass root lead generation 
...
with us. 
      ...
      <div class={`${styles.box} h-72 md:h-96 w-full md:w-1/2 lg:w-1/4 mb-4 lg:mb-0`}>
        <a  class="h-72 md:h-96 block group relative mx-2 overflow-hidden shadow-lg">
          ...
          <div class="absolute left-0 right-0 bottom-0 p-6 z-30 transform translate-y-1/2 transition duration-300 h-full group-hover:translate-y-0 delay-100">
            <div class="h-1/2 relative">
              <div class="absolute bottom-0">
                <h2 class="font-bold text-white leading-tight transition duration-300 text-xl pb-6 group-hover:underline">Governance</h2>
              </div>
            </div>
            <div class="h-1/2">
                <h3 class="font-bold text-white leading-tight transition duration-300 text- group-hover:underline">Scheme Outreach</h3>
              <p class="text-white pb-4 opacity-0 transition duration-300 group-hover:opacity-100">Facilitates the application process to get information and assistance on all 
...
payments.  
      ...
      <div class={`${styles.box} h-72 md:h-96 w-full md:w-1/2 lg:w-1/4 mb-4 md:mb-0`}>
        <a  class="h-72 md:h-96 block group relative mx-2 overflow-hidden shadow-lg">
          ...
          <div class="absolute left-0 right-0 bottom-0 p-6 z-30 transform translate-y-1/2 transition duration-300 h-full group-hover:translate-y-0 delay-100">
            <div class="h-1/2 relative">
              <div class="absolute bottom-0">
                <h2 class="font-bold text-white leading-tight transition duration-300 text-xl pb-6 group-hover:underline">Corporate</h2>
              </div>
            </div>
            <div class="h-1/2">
                <h3 class="font-bold text-white leading-tight transition duration-300 text- group-hover:underline">Content creation</h3>
              <p class="text-white pb-4 opacity-0 transition duration-300 group-hover:opacity-100">We create various types of advertising for the company, including blog posts, 
...
`
  ...
  <div class="max-w-screen-xl mx-auto px-4 pt-16 pb-4">
    <div class="flex flex-col justify-center flex-wrap md:flex-row md:-mx-2">
      <div class={`${styles.box} w-full md:w-1/2 lg:w-1/4 mb-4 lg:mb-0`}>
        <a  class="h-72 md:h-96 block group relative mx-2 overflow-hidden shadow-lg">
          ...
          <div class="absolute left-0 right-0 bottom-0 p-6 z-30 transform translate-y-1/2 transition duration-300 h-full group-hover:translate-y-0 delay-100">
            <div class="h-1/2 relative">
              <div class="absolute bottom-0">
                <h2 class="font-bold text-white leading-tight transition duration-300 text-2xl pb-6 group-hover:underline">Buisness 360</h2>
              </div> 
            </div>
            <div class="h-1/2">
                {/* <h3 class="font-bold text-white leading-tight transition duration-300 text- group-hover:underline">Ground Intelligence</h3> */}
              <p class="text-white pb-4 opacity-0 transition duration-300 group-hover:opacity-100">In our organization, we are putting in place a framework for financial 
      ...
      <div class={`${styles.box} h-72 md:h-96 w-full md:w-1/2 lg:w-1/4 mb-4 lg:mb-0`}>
        <a  class="h-72 md:h-96 block group relative mx-2 overflow-hidden shadow-lg">
          ...
          <div class="absolute left-0 right-0 bottom-0 p-6 z-30 transform translate-y-1/2 transition duration-300 h-full group-hover:translate-y-0 delay-100">
            <div class="h-1/2 relative">
              <div class="absolute bottom-0">
                <h2 class="font-bold text-white leading-tight transition duration-300 text-xl pb-6 group-hover:underline">Growth Hacks</h2>
              </div>
            </div>
            <div class="h-1/2">
                {/* <h3 class="font-bold text-white leading-tight transition duration-300 text- group-hover:underline">Scheme Outreach</h3> */}
              <p class="text-white pb-4 opacity-0 transition duration-300 group-hover:opacity-100">In our organization, we use cost-effective and resource-light digital marketing 
      ...
      <div class={`${styles.box} h-72 md:h-96 w-full md:w-1/2 lg:w-1/4 mb-4 md:mb-0`}>
        <a  class="h-72 md:h-96 block group relative mx-2 overflow-hidden shadow-lg">
          ...
          <div class="absolute left-0 right-0 bottom-0 p-6 z-30 transform translate-y-1/2 transition duration-300 h-full group-hover:translate-y-0 delay-100">
            <div class="h-1/2 relative">
              <div class="absolute bottom-0">
                <h2 class="font-bold text-white leading-tight transition duration-300 text-xl pb-6 group-hover:underline">Public-Private Partnership</h2>
              </div>
            </div>
            <div class="h-1/2">
                {/* <h3 class="font-bold text-white leading-tight transition duration-300 text- group-hover:underline">Content creation</h3> */}
              <p class="text-white pb-4 opacity-0 transition duration-300 group-hover:opacity-100">In our organization, we do this: A long-term agreement between a government 
      ...
      <div class={`${styles.box} w-full md:w-1/2 lg:w-1/4 mb-4 lg:mb-0`}>
        <a  class="h-72 md:h-96 block group relative mx-2 overflow-hidden shadow-lg">
          ...
          <div class="absolute left-0 right-0 bottom-0 p-6 z-30 transform translate-y-1/2 transition duration-300 h-full group-hover:translate-y-0 delay-100">
            <div class="h-1/2 relative">
              <div class="absolute bottom-0">
                <h2 class="font-bold text-white leading-tight transition duration-300 text-2xl pb-6 group-hover:underline">Multimedia Connectivity Hub</h2>
              </div> 
            </div>
            <div class="h-1/2">
                {/* <h3 class="font-bold text-white leading-tight transition duration-300 text- group-hover:underline">Ground Intelligence</h3> */}
              <p class="text-white pb-4 opacity-0 transition duration-300 group-hover:opacity-100">uses top-notch audio and video conferencing tools to enable smooth 
      ...
      <div class={`${styles.box} h-72 md:h-96 w-full md:w-1/2 lg:w-1/4 mb-4 lg:mb-0`}>
        <a  class="h-72 md:h-96 block group relative mx-2 overflow-hidden shadow-lg">
          ...
          <div class="absolute left-0 right-0 bottom-0 p-6 z-30 transform translate-y-1/2 transition duration-300 h-full group-hover:translate-y-0 delay-100">
            <div class="h-1/2 relative">
              <div class="absolute bottom-0">
                <h2 class="font-bold text-white leading-tight transition duration-300 text-xl pb-6 group-hover:underline">Multiple Bots</h2>
              </div>
            </div>
            <div class="h-1/2">
                {/* <h3 class="font-bold text-white leading-tight transition duration-300 text- group-hover:underline">Scheme Outreach</h3> */}
              <p class="text-white pb-4 opacity-0 transition duration-300 group-hover:opacity-100">uses intelligent bots to automate procedures, manage repetitive chores, and 
      ...
      <div class={`${styles.box} h-72 md:h-96 w-full md:w-1/2 lg:w-1/4 mb-4 md:mb-0`}>
        <a  class="h-72 md:h-96 block group relative mx-2 overflow-hidden shadow-lg">
          ...
          <div class="absolute left-0 right-0 bottom-0 p-6 z-30 transform translate-y-1/2 transition duration-300 h-full group-hover:translate-y-0 delay-100">
            <div class="h-1/2 relative">
              <div class="absolute bottom-0">
                <h2 class="font-bold text-white leading-tight transition duration-300 text-xl pb-6 group-hover:underline">AI-Based Personalized Outreach</h2>
              </div>
            </div>
            <div class="h-1/2">
                {/* <h3 class="font-bold text-white leading-tight transition duration-300 text- group-hover:underline">Content creation</h3> */}
              <p class="text-white pb-4 opacity-0 transition duration-300 group-hover:opacity-100">makes use of artificial intelligence to develop customized outreach initiatives. 
      ...
      <div class={`${styles.box} h-72 md:h-96 w-full md:w-1/2 lg:w-1/4 mb-4 md:mb-0`}>
        <a  class="h-72 md:h-96 block group relative mx-2 overflow-hidden shadow-lg">
          ...
          <div class="absolute left-0 right-0 bottom-0 p-6 z-30 transform translate-y-1/2 transition duration-300 h-full group-hover:translate-y-0 delay-100">
            <div class="h-1/2 relative">
              <div class="absolute bottom-0">
                <h2 class="font-bold text-white leading-tight transition duration-300 text-xl pb-6 group-hover:underline">Personalized and Targeted Outreach</h2>
              </div>
            </div>
            <div class="h-1/2">
              <p class="text-white pb-4 opacity-0 transition duration-300 group-hover:opacity-100">uses segmentation and advanced analytics to precisely target particular 
              audience groups..</p>
              {/* <button class="bg-white text-black text-sm px-3 py-1 font-semibold opacity-0 transition duration-300 group-hover:opacity-100 border-2 border-white focus:border-black focus:bg-gray-300">Read More</button> */}
              <button
                      className="bg-white text-black text-sm  font-semibold opacity-0 transition duration-300 group-hover:opacity-100 border-2 border-white focus:border-black focus:bg-gray-300"
...
requirements and preferences of the audience. 
      ...
      <div class={`${styles.box} h-72 mt-5 md:h-96 w-full md:w-1/2 lg:w-1/4 mb-4 md:mb-0`}>
        <a  class="h-72 md:h-96 block group relative mx-2 overflow-hidden shadow-lg">
          ...
          <div class="absolute left-0 right-0 bottom-0 p-6 z-30 transform translate-y-1/2 transition duration-300 h-full group-hover:translate-y-0 delay-100">
            <div class="h-1/2 relative">
              <div class="absolute bottom-0">
                <h2 class="font-bold text-white leading-tight transition duration-300 text-xl pb-6 group-hover:underline">Inclusion of the Last Mile</h2>
              </div>
            </div>
            <div class="h-1/2">
              <p class="text-white pb-4 opacity-0 transition duration-300 group-hover:opacity-100">aims to close the digital divide by providing IT services to underserved or rural 
              communities...</p>
              {/* <button class="bg-white text-black text-sm px-3 py-1 font-semibold opacity-0 transition duration-300 group-hover:opacity-100 border-2 border-white focus:border-black focus:bg-gray-300">Read More</button> */}
          <button
                      className="bg-white text-black text-sm  font-semibold opacity-0 transition duration-300 group-hover:opacity-100 border-2 border-white focus:border-black focus:bg-gray-300"
